...
--------------------------*/
  var Ajax_v5 = {
    ...
    addConfigData: async function (config_) {
      ...
      const getUrl = await fetch(
        `https://site-api.revendi.app/api/magazines/${brand}/${slug}/download`,
        {
          method: "GET",
          headers: {
      ...
      const getUrlJson = await getUrl.json();
    ...
    load_config: async function (cat_) {
      await Ajax_v5.addConfigData();
